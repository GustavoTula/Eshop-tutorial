...
// Definiendo el componente funcional AdminDashboardSellers
    ...
    <div>
      ...
      <div className="w-full flex">
        ...
        <div className="flex items-start justify-between w-full">
          ...
          {/* Componente principal de la página, que muestra todos los vendedores */}
          <AllSellers />
        </div>
      </div>
    </div>
...
// Exportando el componente AdminDashboardSellers para su uso en otros archivos
