...
// Componente funcional que muestra todos los usuarios para administradores.
const AllUsers = () => {
  ...
  const columns = [
    ...
    { field: "joinedAt", headerName: "Joined At", type: "text", minWidth: 130, flex: 0.8 },
    {
      ...
      renderCell: (params) => {
        return (
          // Botón para eliminar un usuario y mostrar un modal de confirmación.
          <>
  ...
  // Construcción de filas de datos para la tabla de usuarios.
  const row = [];
  users &&
    users.forEach((item) => {
      row.push({
